...
def assess_your_story():
    ...
    selfassessment["creativity"] = st.select_slider('Creativity', options['very generic', 'somewhat generic', 'undecided', 'somewhat inspiring', 'very inspiring'], value=('very generic', 'very inspiring'))
